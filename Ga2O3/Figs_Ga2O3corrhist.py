...
# Read in data
fn = r"Ga2O3 epos files\R20_18170_vbmq_corr.epos"
#fn = r"Ga2O3 epos files\R44_03672_vbmq_corr.epos"
...
def plot_2d_histo(ax, N, x_edges, y_edges, log=True):
    ...
    ax.imshow(np.transpose(vals), aspect='auto',
...
fig.clf()
ax = fig.gca()   
plot_2d_histo(ax, ch, edges, edges, log=True)
