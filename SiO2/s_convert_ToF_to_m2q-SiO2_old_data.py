...
ref_fn = r"Q:\NIST_Projects\EUV_APT_IMS\BWC\R20_07071-v01.epos"
...
fn = r"Q:\NIST_Projects\EUV_APT_IMS\BWC\R20_07071-v01.epos"
epos = apt_fileio.read_epos_numpy(fn)
#epos = epos[25000:-1]

# Plot TOF vs event index and show the current ROI selection
roi_event_idxs = np.arange(20000,epos.size-1000)
